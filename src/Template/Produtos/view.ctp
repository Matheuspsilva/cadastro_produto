...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Produto'), ['action' => 'edit', $produto->codigo]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Produto'), ['action' => 'delete', $produto->codigo], ['confirm' => __('Are you sure you want to delete # {0}?', $produto->codigo)]) ?> </li>
